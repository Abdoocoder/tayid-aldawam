...
*   **🏗️ مسار اعتماد خماسي المراحل**: دورة عمل مؤتمتة تبدأ من الميدان وتنتهي في قسم الرواتب.
...
| :--- | :--- | :--- | :--- |
| **Framework** | [Next.js](https://nextjs.org/) | 15.1+ (App Router) | إطار العمل الأساسي للواجهات والـ API |
| **React** | [React](https://react.dev/) | 19.0 | محرك تشغيل الواجهات وتدفق البيانات |
| **Language** | [TypeScript](https://www.typescriptlang.org/) | 5.0+ | لغة البرمجة لضمان Type Safety |
| **Styling** | [Tailwind CSS](https://tailwindcss.com/) | 4.0 | تصميم الواجهات بنظام Utility-first المتطور |
...
| **المالية والرواتب** | `finance` | التدقيق المالي، إصدار أوامر الصرف، وتصدير التقارير النهائية للمحاسبة. |
