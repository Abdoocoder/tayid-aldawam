...
*   **👤 إدارة حالة العامل (Suspend/Resume)**: [جديد] تمكين قسم الموارد البشرية من إيقاف العمال مؤقتاً عن العمل أو إعادتهم، مع إخفاء العمال الموقوفين تلقائياً من واجهات تسجيل الحضور للمراقبين.
*   **🌍 إدارة المناطق المتعددة (Multi-Area Support)**: دعم كامل لإسناد مناطق متعددة للمستخدم الواحد مع تحويل ذكي لمعرفات المناطق لأسماء مفهومة في جميع الواجهات.
*   **⚡ أداء فائق وواجهات ديناميكية**: تحسين سرعة التحميل عبر Dynamic Imports و Skeletons، مع نظام توجيه فوري (Instant Routing) للمستخدمين.
