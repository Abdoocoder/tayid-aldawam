...
### إدارة السجلات المرفوضة وتصحيحها:
إذا ظهر لك تنبيه باللون الأحمر في كشف الحضور، فهذا يعني أن هناك سجلاً تم رفضه من قبل الإدارة لإعادة التدقيق.
1.  **عرض سبب الرفض**: ستظهر لك رسالة واضحة (مثلاً: "يرجى التأكد من أيام العطل") داخل كرت العامل.
2.  **التصحيح**: اضغط على زر **"تصحيح"** لفتح السجل وتعديل البيانات بناءً على الملاحظة.
3.  **إعادة الإرسال**: بعد التعديل، اضغط "حفظ" ليتم إرسال السجل مرة أخرى للمراقب العام برتبة `PENDING_GS`.
...
4.  **نظام الرفض المسبب**: عند اكتشاف خطأ، يمكنك رفض السجل وكتابة "سبب الرفض" ليعود للمراقب الميداني مع التعليمات اللازمة.
...
**س: كيف أعرف سبب رفض السجل الذي قمت برفعه؟**
*   **ج**: سيظهر لك السجل المرفوض في لوحتك الرئيسية مع "ملاحظة التعديل" باللون الأصفر، توضح لك السبب المكتوب من قبل المدقق (نقص وثائق، خطأ في الحساب، إلخ).
...
<div align="center">
  ...
  <p>جميع الحقوق محفوظة لـ <a href="https://portfolio-abdoocoders-projects.vercel.app/">abdoocoder</a></p>
</div>
