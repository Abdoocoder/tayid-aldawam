...
8.  [مدير النظام (Admin) - التحكم المركزي والرقابة](#دليل-المدير)
9.  [رئيس البلدية (Mayor) - التقارير الاستراتيجية](#دليل-الرئيس)
10. [دورة حياة السجل (Workflow Diagram)](#دورة-الحياة)
11. [الأسئلة الشائعة والدعم التقني](#الدعم)
...
<a name="الدعم"></a>
## 🛠️ 11. الأسئلة الشائعة والدعم التقني
