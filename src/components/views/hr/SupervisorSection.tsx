    ...
    return (
        <Card className="border-none shadow-sm overflow-hidden">
            <CardHeader className="flex flex-row items-center justify-between border-b border-gray-100 bg-white p-6">
                <div>
                    <CardTitle className="text-lg font-bold">إدارة فريق المراقبين</CardTitle>
            ...
            <CardContent className="p-0 overflow-x-auto">
                {filteredSupervisors.length === 0 ? (
                    <EmptyState
                        icon={Users}
                        title="لا يوجد مراقبين"
                        description={searchTerm ? "لم نجد مراقبين يطابقون بحثك" : "ابدأ بإضافة أول مراقب للنظام"}
                        action={!searchTerm && (
